  ...
  return (
    <div className="flex flex-col w-full max-w-[800px] mx-auto py-8 px-4 sm:px-6 relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
        <nav className="flex items-center gap-1.5 text-on-secondary-container text-xs">
          ...
          <span className="material-symbols-outlined text-[14px] opacity-40">chevron_right</span>
          <span className="text-on-primary-container font-semibold">Verify Payload</span>
        </nav>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
        <div>
          <div className="inline-flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-on-secondary-container font-medium">Grand Hôtel Stockholm Tenant</span>
          </div>
          <h1 className="text-[28px] sm:text-[32px] text-on-primary-container font-bold tracking-tight">Review Extracted RFP</h1>
        </div>

        {/* JSON / Form Interactive Segmented Pill */}
        <div className="inline-flex p-1 bg-surface-container rounded-xl self-start md:self-auto shadow-sm border border-secondary/20">
          <button
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 ${
              viewMode === "structured"
                ? "bg-surface-container text-on-primary-container shadow-sm"
                : "text-on-secondary-container hover:text-on-primary-container"
            }`}
          ...
          >
            ...
            <span>Zod JSON</span>
            <span className="px-1.5 py-0.5 rounded bg-surface-container text-[10px] font-mono">schema</span>
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          <div className="bg-surface-container rounded-2xl p-4 shadow-sm relative overflow-hidden border border-secondary/20">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] uppercase tracking-wider text-on-secondary-container font-bold">
                  Audio Reference
                </span>
              </div>
              <span className="text-xs text-on-secondary-container font-mono">00:32 / 00:32</span>
            </div>

            <div className="flex items-center gap-3 mt-2">
              <button
                className="w-11 h-11 rounded-xl bg-primary hover:bg-primary transition-colors flex items-center justify-center text-on-primary shadow-sm flex-shrink-0 group cursor-pointer"
                onClick={toggleAudio}
                type="button"
              ...
              <div className="flex-1 flex items-center gap-[3px] h-10 px-2 rounded-lg bg-surface-container overflow-hidden">
                {[3, 5, 8, 4, 7, 9, 6, 3, 8, 10, 7, 4, 6, 9, 5, 2, 2, 3, 2, 2].map((h, i) => (
                  <div
                    key={i}
                    className={`w-1 rounded-full transition-all duration-300 ${
                      i < 15 ? (isPlayingAudio ? "bg-primary animate-pulse" : "bg-primary") : "bg-secondary/60"
                    }`}
            ...
            <div className="flex items-center justify-between text-on-secondary-container text-[11px] pt-3 mt-2 border-t border-secondary/15 opacity-80">
          ...
          <div className="bg-surface-container rounded-2xl p-4 sm:p-5 shadow-sm flex flex-col flex-1 border border-secondary/20">
            <div className="flex items-center justify-between pb-2 mb-2 border-b border-surface-container/40">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-primary text-[18px]">transcribe</span>
                <span className="text-sm font-semibold text-on-primary-container">Spoken Transcript</span>
              </div>
              <span className="text-[11px] px-2 py-0.5 rounded-md bg-surface-container text-on-secondary-container font-medium">
                Live Dictation
              </span>
            </div>

            <p className="text-xs sm:text-[13px] text-on-primary-container leading-relaxed mb-4">
              "Hi Proposales team, this is for{" "}
              <mark className="bg-secondary-container/70 text-on-secondary-container px-1 rounded font-medium">
                {payload.organization.name}
              </mark>
              . Point of contact is{" "}
              <mark className="bg-primary-container/70 text-on-primary-container px-1 rounded font-medium">
                {payload.organization.contact.name}
              </mark>{" "}
              at{" "}
              <mark className="bg-surface-container text-on-primary-container font-mono text-[11px] px-1 rounded">
                {payload.organization.contact.email}
              </mark>
              . They need a complete company offsite and conference arriving{" "}
              <mark className="bg-tertiary-container text-on-tertiary-container px-1 rounded font-medium">March 3rd 2027</mark> and
              checking out on the{" "}
              <mark className="bg-tertiary-container text-on-tertiary-container px-1 rounded font-medium">5th</mark>.
              Approximately{" "}
              <mark className="bg-secondary-container/70 text-on-secondary-container px-1 rounded font-medium">
              ...
              <mark className="bg-primary-container text-on-primary-container px-1 rounded font-semibold">
            ...
            <div className="mt-auto pt-3 bg-surface-container/70 rounded-xl p-3 border border-secondary/15">
              <span className="text-[10px] uppercase tracking-wider text-on-secondary-container block mb-1.5 font-bold">
                Entity Mapping
              </span>
              <div className="flex flex-wrap gap-1.5">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-secondary-container text-on-secondary-container text-[11px]">
                  <span className="w-1.5 h-1.5 rounded-full bg-secondary" /> Organization &amp; Guests
                </span>
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-tertiary-container text-on-tertiary-container text-[11px]">
                  <span className="w-1.5 h-1.5 rounded-full bg-tertiary" /> Dates &amp; Schedule
                </span>
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary-container text-on-primary-container text-[11px]">
        ...
        <div className="lg:col-span-7 flex flex-col">
          {viewMode === "structured" ? (
            <div className="bg-surface-container rounded-2xl p-5 sm:p-6 shadow-sm flex flex-col gap-4 border border-secondary/20">
              <div className="flex items-center justify-between pb-1">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-primary text-[20px]">inventory_2</span>
                  <h2 className="text-base font-semibold text-on-primary-container">Structured Payload Parameters</h2>
                </div>
              ...
              <div className="bg-surface-container rounded-xl p-4 flex flex-col gap-2 border border-secondary/15">
                <div className="text-xs uppercase tracking-wider text-on-secondary-container font-bold">
                  Client Identification
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-1">
                  <div>
                    <label className="block text-xs text-on-secondary-container mb-1 font-medium">Organization Name</label>
                    {isEditingManual ? (
                      <input
                        className="w-full bg-surface-container rounded-lg px-3 py-1.5 text-xs text-on-primary-container font-medium border border-primary focus:outline-none"
                      ...
                      <div className="bg-surface-container rounded-lg px-3 py-2 text-xs text-on-primary-container font-medium shadow-sm flex items-center justify-between">
                  ...
                  <div>
                    <label className="block text-xs text-on-secondary-container mb-1 font-medium">Event Classification</label>
                    <div className="bg-surface-container rounded-lg px-3 py-2 text-xs text-on-primary-container font-medium shadow-sm flex items-center justify-between">
                ...
                <div className="mt-1">
                  <label className="block text-xs text-on-secondary-container mb-1 font-medium">Primary Organizer &amp; Contact</label>
                  <div className="bg-surface-container rounded-lg px-3 py-2 text-xs text-on-primary-container shadow-sm flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-on-primary-container">{payload.organization.contact.name}</span>
                      <span className="text-on-secondary-container font-mono text-xs">
                        {payload.organization.contact.email}
                      </span>
                    </div>
                    <span className="px-2 py-0.5 rounded bg-surface-container text-on-secondary-container text-[11px] font-mono font-medium">
                      Verified Lead
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-surface-container rounded-xl p-4 flex flex-col gap-2 border border-secondary/15">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-1">
                  <div>
                    <label className="block text-xs text-on-secondary-container mb-1 font-medium">Itinerary Window</label>
                    <div className="bg-surface-container rounded-lg px-3 py-2 text-xs text-on-primary-container font-medium shadow-sm">
                      3 Mar 2027 — 5 Mar 2027
                      <div className="text-[11px] text-on-secondary-container font-normal">
                  ...
                  <div>
                    <label className="block text-xs text-on-secondary-container mb-1 font-medium">
              ...
              <div className="bg-surface-container rounded-xl p-4 flex flex-col gap-2 border border-secondary/15">
                ...
                <div className="space-y-2 mt-1">
                  <div>
                    ...
                    <div className="bg-surface-container rounded-lg px-3 py-2 text-xs text-on-primary-container shadow-sm flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-on-secondary-container">
                  ...
                  <div>
                    ...
                    <div className="bg-surface-container rounded-lg px-3 py-2 text-xs text-on-primary-container shadow-sm italic text-on-secondary-container">
              ...
              <div className="bg-surface-container rounded-xl p-4 border border-secondary/15">
                <div className="flex items-center justify-between mb-2">
                ...
                <div className="bg-surface-container rounded-lg p-3 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    <div className="text-[24px] sm:text-[28px] text-on-primary-container tracking-tight font-bold">
                      {payload.financials.totalBudgetSEK.toLocaleString()} SEK
                    </div>
                    <div className="text-xs text-on-secondary-container">Calculated RevPAG: 3,750 SEK / guest-day</div>
                  </div>

                  {/* Nordic Margin Visualization SVG Spark Gauge */}
                  <div className="flex items-center gap-3 bg-surface-container px-3 py-2 rounded-xl">
                    <div className="relative w-12 h-12 flex items-center justify-center">
                      ...
                      <span className="absolute text-[11px] font-bold text-on-primary-container">34%</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-xs text-on-primary-container font-semibold">Estimated Margin</span>
            ...
            <div className="bg-primary text-on-primary rounded-2xl p-6 shadow-sm flex flex-col gap-4 font-mono border border-secondary/20">
              <div className="flex items-center justify-between pb-2 text-on-primary-container border-b border-white/10">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-[18px]">code</span>
                  <span className="text-xs text-on-primary font-sans font-semibold">
                    Live Zod-Parsed Output Payload
                  </span>
                </div>
                <button
                  className="hover:text-white flex items-center gap-1 text-xs text-on-primary/80 transition-colors font-sans cursor-pointer"
              ...
              <pre className="text-[11px] text-secondary-container overflow-x-auto p-4 bg-surface-container/10 rounded-xl leading-relaxed max-h-[500px]">
      ...
      <div className="sticky bottom-4 z-30 w-full bg-surface-container/95 backdrop-blur-md rounded-2xl p-3 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-3 border border-secondary/25">
        <div className="flex items-center gap-2 w-full sm:w-auto flex-wrap">
          <button
            className="flex-1 sm:flex-none h-11 px-4 rounded-xl bg-surface-container hover:bg-surface-container text-on-primary-container text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
            onClick={onReRecord}
            type="button"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none h-11 px-4 rounded-xl bg-secondary-container hover:bg-secondary-container text-on-secondary-container text-xs font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer shadow-xs"
